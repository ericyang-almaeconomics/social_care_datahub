...
MEASURE_GROUP_SELECTION_CHOICES = (
    ...
    'Delayed transfers of care from hospital per 100,000 population'),
    ('Delayed transfers of care from hospital that are attributable to adult social care, per 100,000 population',
    'Delayed transfers of care from hospital that are attributable to adult social care, per 100,000 population'),
    ('Delayed transfers of care from hospital that are jointly attributable to NHS and adult social care, per 100,000 population',
    'Delayed transfers of care from hospital that are jointly attributable to NHS and adult social care, per 100,000 population'),
    ('Delayed transfers of care from hospital which are attributable to adult social care per 100,000 population',
    'Delayed transfers of care from hospital which are attributable to adult social care per 100,000 population'),
    ('Delayed transfers of care from hospital which are jointly attributable to the NHS and adult social care per 100,000 population',
    'Delayed transfers of care from hospital which are jointly attributable to the NHS and adult social care per 100,000 population'),
    ('Delayed transfers of care from hospital, per 100,000 population',
    'Delayed transfers of care from hospital, per 100,000 population'),
    ...
    'Proportion of carers who receive direct payments'),
    ('Proportion of carers who receive self-directed support',
    'Proportion of carers who receive self-directed support'),
    ('Proportion of older people 65 and over who were still at home 91 days after discharge from hospital into reablement/rehabilitation services effectiveness of the service',
    'Proportion of older people 65 and over who were still at home 91 days after discharge from hospital into reablement/rehabilitation services effectiveness of the service'),
    ('Proportion of older people 65 and over who were still at home 91 days after discharge from hospital into reablement/rehabilitation services offered the service',
    'Proportion of older people 65 and over who were still at home 91 days after discharge from hospital into reablement/rehabilitation services offered the service'),
    ...
    'Proportion of people using social care who receive self-directed support'),
    ('Proportion of people who use services and carers who find it easy to find information about services',
    'Proportion of people who use services and carers who find it easy to find information about services'),
    ...
    'Proportion of people who use services who say that those services have made them feel safe and secure'),
    ('Proportion of those that received a short term service during the year where the sequel to service was either no ongoing support or support of a lower level',
    'Proportion of those that received a short term service during the year where the sequel to service was either no ongoing support or support of a lower level'),
    ...
    'The outcome of short-term services: sequel to service'),
    ('The proportion of adults in contact with secondary mental health services in paid employment',
    'The proportion of adults in contact with secondary mental health services in paid employment'),
    ('The proportion of adults in contact with secondary mental health services living independently, with or without support',
    'The proportion of adults in contact with secondary mental health services living independently, with or without support'),
    ...
    'The proportion of adults with a learning disability who live in their own home or with their family'),
    ('The proportion of carers who find it easy to find information about support',
    'The proportion of carers who find it easy to find information about support'),
    ('The proportion of carers who receive direct payments',
    'The proportion of carers who receive direct payments'),
    ('The proportion of carers who receive self-directed support',
    'The proportion of carers who receive self-directed support'),
    ...
    'The proportion of carers who reported that they had as much social contact as they would like'),
    ('The proportion of older people (aged 65 and over) who received reablement/rehabilitation services after discharge from hospital',
    'The proportion of older people (aged 65 and over) who received reablement/rehabilitation services after discharge from hospital'),
    ...
    'The proportion of people who use services who receive direct payments'),
    ('The proportion of people who use services who receive self-directed support',
    'The proportion of people who use services who receive self-directed support'),
